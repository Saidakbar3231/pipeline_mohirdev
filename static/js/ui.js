...
var LANG = {
  uz: {
    ...
    tab_8: "8 · Training",
    // Header
    site_sub: "Speech Dataset Tool · v2.0",
    logout: "Chiqish",
    // Tab 1 Pipeline
    ...
    f_music: "Fon musiqali audiolarni o'chirish",
    f_music_d: "Orqa fonda musiqa yoki kuchli shovqin bor bo'lsa — filtrlanadi",
    f_multi: "Ko'p kishi gapirayotgan audiolarni o'chirish",
    f_multi_d: "STT dataset uchun bitta ovoz bo'lishi kerak",
    ...
    meta_title: "Aisha v2 metadata filtri",
    ...
    // Alerts
    alert_aisha: "AIsha STT API kalitini kiriting (Yo'l 1 uchun).",
  ...
  ru: {
    ...
    f_music: "Удалять аудио с фоновой музыкой",
    f_music_d: "Если на фоне музыка или сильный шум — фильтруется",
    f_multi: "Удалять аудио с несколькими голосами",
    f_multi_d: "Для STT датасета нужен один голос",
    ...
    meta_title: "Фильтр метаданных Aisha v2",
    ...
    alert_aisha: "Введите ключ AIsha STT API (для Пути 1).",
  ...
  en: {
    ...
    f_music: "Remove audio with background music",
    f_music_d: "If background has music or strong noise — filtered out",
    f_multi: "Remove audio with multiple speakers",
    f_multi_d: "STT dataset requires a single voice",
    ...
    meta_title: "Aisha v2 Metadata Filter",
    ...
    alert_aisha: "Enter AIsha STT API key (for Path 1).",
